...
IlcManagerI* IlcGetManagerI(const IloCPI* cp);
...
IloCPI* IlcGetCPI(const IlcManagerI *);
#ifndef ILC_NO_PROPAGATION_TRACE
#define ILC_HAS_PROPAGATION_TRACE
#endif
...
public:                                                                 \
  ...
  IloCPI* getCPI() const { return _getCPI(); }                          \
  IloSolver getSolver() const { return getCP(); }                       \
  IloCP getManager() const { return getCP(); }                          \
...
private:                                                                \
                                                                        \
  void _ctor(IloCP s, IlcInt size);                               \
  void _ctor(IloCP s, IlcInt size, E * items);                    \
  void _ctor(IloCP s, E v1);                                      \
  void _ctor(IloCP s, E v1, E v2);                                \
  void _ctor(IloCP s, E v1, E v2, E v3);                          \
  void _ctor(IloCP s, E v1, E v2, E v3, E v4);                    \
  void _ctor(IloCP s, E v1, E v2, E v3, E v4, E v5);              \
  void _ctor(IloCP s, E v1, E v2, E v3, E v4, E v5, E v6);        \
  void _ctor(IloCP s, E v1, E v2, E v3, E v4, E v5, E v6, E v7);  \
  void _ctor(IloCP s, E v1, E v2, E v3, E v4, E v5, E v6, E v7, E v8); \
  void _ctor(IloCP s, E v1, E v2, E v3, E v4, E v5, E v6, E v7, E v8, \
             E v9);                                                     \
  void _ctor(IloCP s, E v1, E v2, E v3, E v4, E v5, E v6, E v7, E v8, \
             E v9, E v10);                                              \
  ...
  IloCPI ** _solverAddr() const { return (IloCPI **)((EI*)_impl - 2); } \
  ...
  IloCP _getCP() const { return * _solverAddr(); }          \
  IloCPI* _getCPI() const { return * _solverAddr(); }       \
  IlcManagerI* _getManagerI() const { return IlcGetManagerI(_getCPI()); } \
  void _display(ILOSTD(ostream)& str) const;                            \
                                                                        \
public:                                                                 \
                                                                     \
  T(IloCP s, IlcInt size) {                                       \
    ...
    _ctor(s, size);                                                     \
                                                                     ...
                                                                     \
  T(IloCP s, IlcInt size, E * items) {                            \
    IlcCPOAssert(s.getImpl() != 0, "IlcCPEngine: empty handle");        \
    IlcCPOAssert(size >= 0, ILO_STRINGIZE(T) "::" ILO_STRINGIZE(T)      \
                         " - size must be positive");                   \
    _ctor(s, size, items);                                              \
  }                                                                     \
  T (IloCP s, IlcInt ILCPARAM(size),                              \
     const E v1)  {                                                     \
    IlcCPOAssert(s.getImpl() != 0, "IlcCPEngine: empty handle");        \
...
private:
  ...
  void _ctor(IloCP s, IlcInt size, IlcInt* values);
  void _ctor(IloCP s, IlcInt size, IlcInt prototype);
public:
 ...
 ILCGETCPHDECL(IlcIntArray)
  ...
  IlcIntArray(IloCP solver, IlcInt size, IlcInt* values) {
  ...
  IlcIntArray(IloCP solver, IlcInt size, IlcInt prototype = 0) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
    IlcCPOAssert(size >= 0, "IlcIntArray: size must be non-negative");
    _ctor(solver, size, prototype);
  }

  IlcIntArray(IloCP solver, IlcInt size, IlcInt exp0, IlcInt exp ...);
#if defined(ILO_HP11) || defined(ILO64)
  IlcIntArray(IloCP solver, IlcInt size, int exp0, int exp ...);
#endif
...
private:
  ...
  void _ctor(IloCP solver, IlcInt size, IlcFloat prototype);
  void _ctor(IloCP solver, IlcInt size, IlcFloat * values);
public:

  IlcFloatArray(IloCP solver, IlcInt size, IlcFloat* values) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
    IlcCPOAssert(size >= 0, "IlcFloatArray: size must be non-negative");
    _ctor(solver, size, values);
  }

  IlcFloatArray(IloCP solver, IlcInt size, IlcFloat prototype = 0) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
    IlcCPOAssert(size >= 0, "IlcFloatArray: size must be non-negative");
    _ctor(solver, size, prototype);
  }
#if defined(ILO_HP11) && defined(ILO64)
  IlcFloatArray(IloCP solver, IlcInt size,
                int exp0,
                IlcVarArgsNum exp ...);
  IlcFloatArray(IloCP solver, IlcInt size,
                IlcInt exp0,
...
# else
  ...
  IlcFloatArray(IloCP solver, IlcInt size, IlcFloat exp0, IlcFloat exp1,...);

  IlcFloatArray(IloCP solver, IlcInt size, IlcInt exp0, IlcInt exp1,...);
#if !defined(ILOINTASINT)
  IlcFloatArray(IloCP solver, IlcInt size, int exp0, int exp ...);
#endif
#endif
...
private:
  ...
  void _ctor(IloCP solver, IlcInt min, IlcInt max, IlcBool fullSet);
  void _ctor(IloCP solver, const IlcIntArray array, IlcBool fullSet);
...
public:
  ...
  IlcIntSet(IloCP solver, IlcInt min, IlcInt max, IlcBool fullSet = IlcTrue) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
    _ctor(solver, min, max, fullSet);
  }

  IlcIntSet(IloCP solver, const IlcIntArray array, IlcBool fullSet = IlcTrue) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
...
class IlcRevBool{
  ...
  void _ctor(IloCP solver, IlcBool initValue);
  void _setValue(IloCP solver, IlcBool value);
public:
  IlcRevBool();

  IlcRevBool(IloCP solver, IlcBool initValue=IlcFalse) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
  ...
  void setValue(IloCP solver, IlcBool value) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
...
class IlcRevInt {
 protected:
  ...
  void _ctor(IloCP solver, IlcInt initValue);
  void _setValue(IloCP solver, IlcInt value);
public:
  IlcRevInt();

  IlcRevInt(IloCP solver, IlcInt initValue=0) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
    _ctor(solver, initValue);
  }
  ...
  void setValue(IloCP solver, IlcInt value) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
    _setValue(solver, value);
  }
...
private:
  ...
  void _ctor(IloCP solver, IlcAny initValue);
  void _setValue(IloCP solver, IlcAny value);
public:
  IlcRevAny();

  IlcRevAny(IloCP solver, IlcAny initValue=0) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
    _ctor(solver, initValue);
  }
  ...
  void setValue(IloCP solver, IlcAny value) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
    _setValue(solver, value);
  }
...
private:
  ...
  void _ctor(IloCP solver, IlcFloat initValue);
  void _setValue(IloCP solver, IlcFloat value);

public:
  IlcRevFloat();

  IlcRevFloat(IloCP solver, IlcFloat initValue = 0.) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
    _ctor(solver, initValue);
  }
  ...
  void setValue(IloCP solver, IlcFloat value) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
    _setValue(solver, value);
  }
...
public:
  ...
  IlcDemonI(IloCP solver, IlcConstraintI * owner = 0);
...
public:
  ...
  IlcGoalI(IloCP solver) : _manager(solver.getManagerI()), _ext(0) { }
  virtual ~IlcGoalI();
...
public:
  ...
  IlcBool hasBeenPrePropagated() const { return getStatusFlag(5); }

public:

  IlcConstraintI(IloCP solver);
...
IlcGoal IlcGoalFail(IloCP solver, IlcAny label=0);
IlcGoal IlcGoalTrue(IloCP solver);
...
#define ILCGOALRTTIDECL
#define ILCGOALRTTI(x,y)
#define ILCGOALRTTI1(x,y,t)
...
private:
  void _ctor(IloCP solver, IlcInt min, IlcInt max, const char * name);
  void _ctor(IloCP solver, const IlcIntArray values, const char * name);
...
public:
  ...
  IlcIntVar(IloCP solver, IlcInt min, IlcInt max, const char* name = 0) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
    _ctor(solver, min, max, name);
  }

  IlcIntVar(IloCP solver, const IlcIntArray values, const char* name = 0) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
...
private:
  ...
  void _ctor(IloCP solver, IlcInt size);
  void _ctor(IloCP solver, IlcInt size, IlcInt min, IlcInt max);
  void _ctor(IloCP solver, IlcInt size, const IlcIntVar prototype);
  void _ctor(IloCP solver, const IlcIntVar v1);
  void _ctor(IloCP solver, const IlcIntVar v1, const IlcIntVar v2);
  void _ctor(IloCP solver, const IlcIntVar v1, const IlcIntVar v2,
             const IlcIntVar v3);
  void _ctor(IloCP solver, const IlcIntVar v1, const IlcIntVar v2,
...
public:
  ...
  IlcIntVarArray(IloCP solver, IlcInt size) {
    IlcCPOAssert(solver.getImpl() != 0, "IloCP: empty handle");
  ...
  IlcIntVarArray(IloCP solver, IlcInt size, const IlcIntVar exp ...);
#endif
  IlcIntVarArray(IloCP solver, IlcInt ILCPARAM(size),
                 const IlcIntVar v1)  {
    IlcCPOAssert(solver.getImpl() != 0, "IloCP: empty handle");
  ...
  IlcIntVarArray(IloCP solver, IlcInt size, IlcInt min, IlcInt max) {
    IlcCPOAssert(solver.getImpl() != 0, "IloCP: empty handle");
    IlcCPOAssert(size >= 0, "IlcIntVarArray::IlcIntVarArray - "
                         "size must be positive");
...
class IlcFloatVar : public IlcFloatExp {
  ...
  void _ctor(IloCP solver, IlcFloat min, IlcFloat max, const char * name);
...
class IlcFloatVarArray {
  ...
  void _ctor(IloCP solver, IlcInt size);
  void _ctor(IloCP solver, IlcInt size, IlcFloat min, IlcFloat max);
  void _ctor(IloCP solver, const IlcFloatVar v1);
  void _ctor(IloCP solver, const IlcFloatVar v1, const IlcFloatVar v2);
  void _ctor(IloCP solver, const IlcFloatVar v1, const IlcFloatVar v2,
...
public:
  ...
  IlcFloatVarArray(IloCP solver, IlcInt size) {
    IlcCPOAssert(solver.getImpl() != 0, "IlcCPEngine: empty handle");
  ...
  IlcFloatVarArray (IloCP solver, IlcInt ILCPARAM(size),
  ...
  IlcFloatVarArray(IloCP solver, IlcInt size, IlcFloat min, IlcFloat max) {
    IlcCPOAssert(solver.getImpl() != 0, "IloCP: empty handle");
    IlcCPOAssert(size >= 0, "IlcFloatVarArray::IlcFloatVarArray - "
                         "size must be positive");
    _ctor(solver, size, min, max);
...
class IlcIntSetVar {
  ...
  void     _ctor(IloCP solver, IlcInt min, IlcInt max, const char * name);
  void     _ctor(IloCP solver, const IlcIntArray domain, const char * name);
  void     _ctor(IloCP solver, const IlcIntSet domain, const char * name);
...
public:
  ...
  IlcIntSetVar(IloCP solver, IlcInt min, IlcInt max, const char* name=0) {
    IlcCPOAssert(solver.getImpl() != 0, "IloCP: empty handle");
    IlcCPOAssert(min <= max, "IlcIntSetVar: min > max");
    _ctor(solver, min, max, name);
  }

  IlcIntSetVar(IloCP solver, const IlcIntArray array, const char* name=0) {
    IlcCPOAssert(solver.getImpl() != 0, "IloCP: empty handle");
    IlcCPOAssert(array.getImpl(), "IlcIntArray: empty handle");
    _ctor(solver, array, name);
  }
  IlcIntSetVar(IloCP solver, const IlcIntSet set, const char* name=0) {
    IlcCPOAssert(solver.getImpl() != 0, "IloCP: empty handle");
...
public:
  ...
  IlcIntSetArray(IloCP solver, IlcInt size, IlcIntArray array);
...
private:
  void _ctor(IloCP solver, IlcInt size, IlcInt min, IlcInt max);
  void _ctor(IloCP solver, IlcInt size, IlcIntArray values);
public:

  IlcIntSetVarArray(IloCP solver, IlcInt size, IlcInt min, IlcInt max) {
    IlcCPOAssert(solver.getImpl() != 0, "IloCP:: empty handle");
  ...
  IlcIntSetVarArray(IloCP solver, IlcInt size, IlcIntArray array) {
    IlcCPOAssert(solver.getImpl() != 0, "IloCP:: empty handle");
    IlcCPOAssert(size >= 0, "IlcIntSetVarArray::IlcIntSetVarArray - "
                         "size must be non-negative");
    IlcCPOAssert(array.getImpl() != 0, "IlcIntArray: empty handle");
...
class IlcIntSelect {
  ...
  void _ctor(IloCP solver, IlcEvalInt function);
public:

  IlcIntSelect(IloCP solver, IlcEvalInt function) {
    IlcCPOAssert(solver.getImpl() != 0, "IloCP: empty handle");
...
IlcGoal IlcSimpleCompletionGoal(IloCP solver);


IloGoal IloSimpleCompletionGoal(IloEnv env);

IlcGoal IlcFailureDirectedSearchGoal(IloCP solver);
...
IlcIntPredicate name(IloCP solver){\
...
IlcIntPredicate name(IloCP solver,type1 arg1){\
...
IlcIntPredicate name(IloCP solver, type1 arg1, type2 arg2){\
...
IlcIntPredicate name(IloCP solver, type1 arg1, type2 arg2, type3 arg3){\
...
IlcIntPredicate name(IloCP solver, type1 arg1, type2 arg2, type3 arg3, type4 arg4){\
...
IlcIntPredicate name(IloCP solver, type1 arg1, type2 arg2, type3 arg3, type4 arg4, type5 arg5){\
...
IlcIntPredicate name(IloCP solver, type1 arg1, type2 arg2, type3 arg3, type4 arg4, type5 arg5, type6 arg6){\
...
class IlcIntTupleSet {
  ...
  void _ctor(IloCP solver, IlcInt arity);
public:

  IlcIntTupleSet(IloCP solver, IlcInt arity) {
    IlcCPOAssert(solver.getImpl() != 0, "IloCP: empty handle");
...
IlcConstraint IlcCustomConstraint(IloCP solver, IloPropagatorI * prop);
...
private:
  ...
  virtual void whenBacktrackOneLevel(IloCP solver);
...
IlcSearchLimit IlcTimeLimit(IloCP solver, IlcFloat limit);


IlcSearchLimit IlcFailLimit(IloCP solver, IlcInt limit);


IlcSearchLimit IlcOrLimit(IloCP solver, IlcInt limit);


IlcSearchLimit IlcBranchLimit(IloCP solver, IlcInt limit);

IlcSearchLimit IlcSolutionLimit(IloCP solver, IlcInt limit);
IlcSearchLimit IlcObjectiveLimit(IloCP solver, IlcFloat limit);
...
public:
  ...
  virtual IlcSearchLimit extract(const IloCP solver) const=0;
...
public:
  ...
  virtual IlcConstraint extract(const IloCP solver) const=0;
  ...
  void use(const IloCP solver, const IloNumVar x) const;

  void use(const IloCP solver, const IloIntervalVar x) const;

  void use(const IloCP solver, const IloIntervalSequenceVar x) const;


  void use(const IloCP solver, const IloIntVarArray xa) const;

  void use(const IloCP solver, const IloNumVarArray xa) const;

  void use(const IloCP solver, const IloIntervalVarArray xa) const;

  void use(const IloCP solver, const IloIntervalSequenceVarArray xa) const;
};
...
public:
  IloCPI* getCPI() const { return _cp; }
  
  IlcCustomInferencerI(IloCP solver, IloBool manualMode=IloFalse, IloNum numberOfSkippedNodes = 20);
...
private:
  void _ctor(IloCPI* cp, const IloInt size);
  IloCPI* _getCPI()              const;
  IlcInt _getSize()                   const;
...
public:
  ...
  IlcIntervalVarArray(const IloCP cp, const IloInt size) {
    IlcCPOAssert(cp.getImpl(), "IlcIntervalVarArray: IloCP empty handle.");
...
public:
  ...
  IlcCumulElementVarArray(const IloCP cp, const IloInt size) {
    IlcCPOAssert(cp.getImpl(), "IlcCumulElementVarArray: IloCP empty handle.");
...
public:
  ...
  IlcIntervalSequenceVarArray(const IloCP cp, const IloInt size) {
    IlcCPOAssert(cp.getImpl(), "IlcIntervalSequenceVarArray: IloCP empty handle.");
