...
IlcIntVar ** MakeIlcMatrix(IloCP cp, IloIntVarArray2 m) {
...
IlcInt ** MakeIlcMatrix(IloCP cp, IloIntArray2 m) {
  IlcInt dim = m.getSize();
...
IlcCustomInferencer IlcMinDistanceInferencer(
  IloCP cp, IlcInt n, IlcIntVar ** a, IlcIntVar ** dist, 
...
protected:
 ...
 public:
  IlcMinDistanceConstraintI(
    IloCP cp, IlcInt n, IlcIntVar ** aa, IlcIntVar ** ddist
